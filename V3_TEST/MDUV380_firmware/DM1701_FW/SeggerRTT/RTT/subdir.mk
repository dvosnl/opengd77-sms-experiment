...
SeggerRTT/RTT/%.o: ../SeggerRTT/RTT/%.S SeggerRTT/RTT/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -DPLATFORM_RT84_DM1701 -DPLATFORM_VARIANT_DM1701 -DDEBUG -c -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
